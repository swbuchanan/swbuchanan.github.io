...
class CanvasGraph {
    constructor(canvasId) {
        ...
        this.canvas.addEventListener('contextmenu', (event) => { event.preventDefault(); }); // keep the context menu from coming up on a right click
    ...
    isMouseOverVertex(mouseX, mouseY) {
